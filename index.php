...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" ><head>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" background="images/index/fon_top.gif" height="147">
        <tr><td align="center" valign="top"><table border="0" cellpadding="0" cellspacing="0" width="740">
                <tr><td valign="middle" height="68"><img src="images/index/LOGO2.gif" alt="" border="0" align="left"></td></tr><tr><td><table border="0" cellpadding="0" cellspacing="0"><tr>
	                    <td><a href=" " title="Anasayfa"><img src="images/btn/b01.gif" height="42" alt="" border="0"></a></td>
	                    <td><a href="?page=cats" title=""><img src="images/btn/b02.gif" height="42" alt="" border="0"></a></td>
	                    <td><a href="?page=cats" title=""><img src="images/btn/b03.gif" height="42" alt="" border="0"></a></td>
	                    <td><a href="?page=sale" title="Satış"><img src="images/btn/b04.gif" height="42" alt="" border="0"></a></td>
	                    <td><a href="?page=account_stlk" title="Hesap"><img src="images/btn/b05.gif" height="42" alt="" border="0"></a></td>
	                    <td><a href="?page=last" title=""><img src="images/btn/b06.gif" height="42" alt="" border="0"></a></td>
	                    <td><a href="?page=help_iletisim" title="İletişim"><img src="images/btn/b07.gif" height="42" alt="" border="0"></a></td>
	                    <td><a href="?page=help" title="Yardım"><img src="images/btn/b08.gif" height="42" alt="" border="0"></a></td>
							...
							<td width="30" align="center"><a href="?page=search_detail" class="titlemini">Detaylı<br>Ara</a></td>
			...
			<? $satno=10;if(substr($page,0,4)=="help"){?>
				<table border="0" cellpadding="0" cellspacing="0" width="149" background="images/index/fon_left02.gif">
                	<tr><td background="images/index/left01.gif" height="26"><p class="title">YARDIM</p></td></tr><tr><td>
	                    <p class="b01"><img src="images/index/e02.gif" width="6" height="5" alt="" border="0" align="absmiddle">&nbsp;&nbsp;<a href="?page=help_yeniuye">Yeni Üyeler</a></p>
						<div align='center'><img src='images/index/hr01.gif' width='137' height='3' alt='' border='0'></div>
	                    <p class="b01"><img src="images/index/e02.gif" width="6" height="5" alt="" border="0" align="absmiddle">&nbsp;&nbsp;<a href="?page=help_alan">Alıcı Rehberi</a></p>
						<div align='center'><img src='images/index/hr01.gif' width='137' height='3' alt='' border='0'></div>
	                    <p class="b01"><img src="images/index/e02.gif" width="6" height="5" alt="" border="0" align="absmiddle">&nbsp;&nbsp;<a href="?page=help_satan">Satıcı Rehberi</a></p>
						<div align='center'><img src='images/index/hr01.gif' width='137' height='3' alt='' border='0'></div>
	                    <p class="b01"><img src="images/index/e02.gif" width="6" height="5" alt="" border="0" align="absmiddle">&nbsp;&nbsp;<a href="?page=help_artirimbitince">Açık Artırma Bitince</a></p>
						<div align='center'><img src='images/index/hr01.gif' width='137' height='3' alt='' border='0'></div>
	                    <p class="b01"><img src="images/index/e02.gif" width="6" height="5" alt="" border="0" align="absmiddle">&nbsp;&nbsp;<a href="?page=help_hesap">Hesabım</a></p>
						<div align='center'><img src='images/index/hr01.gif' width='137' height='3' alt='' border='0'></div>
	                    <p class="b01"><img src="images/index/e02.gif" width="6" height="5" alt="" border="0" align="absmiddle">&nbsp;&nbsp;<a href="?page=help_sozlesme">Sözleşme Koşulları</a></p>
						<div align='center'><img src='images/index/hr01.gif' width='137' height='3' alt='' border='0'></div>
	                    <p class="b01"><img src="images/index/e02.gif" width="6" height="5" alt="" border="0" align="absmiddle">&nbsp;&nbsp;<a href="?page=help_kural">Site Kuralları</a></p>
						<div align='center'><img src='images/index/hr01.gif' width='137' height='3' alt='' border='0'></div>
	                    <p class="b01"><img src="images/index/e02.gif" width="6" height="5" alt="" border="0" align="absmiddle">&nbsp;&nbsp;<a href="?page=help_sss">Sıkça Sorulan Sorular</a></p>
						<div align='center'><img src='images/index/hr01.gif' width='137' height='3' alt='' border='0'></div>
	                    <p class="b01"><img src="images/index/e02.gif" width="6" height="5" alt="" border="0" align="absmiddle">&nbsp;&nbsp;<a href="?page=help_biz">Hakkımızda</a></p>
						<div align='center'><img src='images/index/hr01.gif' width='137' height='3' alt='' border='0'></div>
	                    <p class="b01"><img src="images/index/e02.gif" width="6" height="5" alt="" border="0" align="absmiddle">&nbsp;&nbsp;<a href="?page=help_gizli">Gizlilik Politikası</a></p>
        ...
        </p></td><td bgcolor="#979797"><img src="images/index/px1.gif" width="1" height="1" alt="" border="0"></td>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="850" align="center"><tr><td width="202" background="images/index/bot_1.gif">&nbsp;</td>
	    	<td height="38" align="right" background="images/index/bot_2.gif"><table border="0" cellpadding="0" cellspacing="0" width="490"><tr><td><p class="menu02" align="center">
                        <a href=" ">Anasayfa</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="?page=help_biz">Hakkımızda</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="?page=help_iletisim">İletişim</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="?page=help">Yardım</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="?page=help_sss">SSS</a>
