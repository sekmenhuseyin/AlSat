...
<TABLE cellSpacing=0 cellPadding=0 border=0 align="center">
	<TR><TD><TABLE style="border:#999999 2px solid;" cellSpacing=0 cellPadding=5 background="images/editor/bg.jpg">
		<TR><TD>
			<TEXTAREA name="cmts" rows="12" wrap="virtual" cols="65"><? if($cmts){echo"$cmts";}else if($oku[ozellik]){echo"$oku[ozellik]";}?></TEXTAREA>
		    <SCRIPT language=javascript src="editor/editor.js"></SCRIPT><SCRIPT language=javascript><!--
